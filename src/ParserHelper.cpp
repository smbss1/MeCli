...
void ParserHelper::DefineArea(const std::string& strId, char c1, char c2)
{
    oLexer.DefineArea(strId, c1, c2);
}
...
bool ParserHelper::IsEnd()
{
    return oLexer.oTokenIterator == oLexer.oTokenList.end();
}
